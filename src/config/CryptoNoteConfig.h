...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0xe7f4f;
...
/* Premine amount */
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(30000000000000000);
...
*/
const char GENESIS_COINBASE_TX_HEX[] = "010a01ff000180808cfaf49aa53502af09883808e1f946b2bd5fbc1274c1c09497ca9401035eb5bcfeaeccbd4d2a8a21011f001734c78eaf2ac96ff2633cbf478dc80cef84f1a56a31ca324b9fc68c0f5b";
static_assert(sizeof(GENESIS_COINBASE_TX_HEX)/sizeof(*GENESIS_COINBASE_TX_HEX) != 1, "GENESIS_COINBASE_TX_HEX must not be empty.");

/* This is the unix timestamp of the first "mined" block (technically block 2, not the genesis block)
   You can get this value by doing "print_block 2" in Balenod. It is used to know what timestamp
   to import from when the block height cannot be found in the node or the node is offline. */
const uint64_t GENESIS_BLOCK_TIMESTAMP                       = 1512800692;

const size_t   CRYPTONOTE_REWARD_BLOCKS_WINDOW               = 30;
...
const char     CRYPTONOTE_NAME[]                             = "Baleno";
